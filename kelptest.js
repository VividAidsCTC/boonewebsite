...
document.addEventListener('DOMContentLoaded', function() {
    // Import Three.js (make sure it's installed as dependency)
    import('three').then((THREE) => {
        console.log('Three.js loaded, creating kelp forest...');
        ...
        const container = document.getElementById('container');
        if (container) {
            container.innerHTML = '<div style="color: white; padding: 20px;">Error: Three.js failed to load. Make sure "three" is added as a dependency.</div>';
        }
    });
});
