...
const ASSET_CONFIG = {
    rocks: [
        {
            name: 'rock1',
            url: 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/rock1.glb',
            scale: { min: 0.5, max: 2.0 },
            yOffset: -1
        },
        {
            name: 'rock2', 
            url: 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/rock2.glb',
            scale: { min: 0.8, max: 1.5 },
            yOffset: -1
        },
        {
            name: 'rock3',
            url: 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/rock3.glb',
    ...
    fish: [
        {
            name: 'fish1',
            url: 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/fish1.glb',
        ...
        {
            name: 'fish2',
            url: 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/fish2.glb',
